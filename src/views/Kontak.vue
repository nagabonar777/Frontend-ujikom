  ...
  <section class="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg">
    <div class="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
        ...
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              ...
              <span class="block text-xs uppercase">Gmail</span>
            </div>
          </li>
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">Chandraal_78</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <p class="font-serif text-base md:text-lg">chandra alviana</p>
      ...
      <div class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
        <h2 class="mb-8 text-2xl font-black">Hii... Ada Yang Ingin Di Tanyakan?</h2>
        <p class="mt-2 mb-4 font-sans text-sm tracking-normal">Bertanyalah sesuai kebutahan anda</p>
        <form action="">
          <div class="md:col-gap-4 mb-5 grid md:grid-cols-2">
            <input class="col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-black" type="text" placeholder="Nama" name="name" />
            <input class="col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-black" type="email" placeholder="tujuan emeil" name="email" />
          </div>
          <textarea class="mb-10 w-full resize-y whitespace-pre-wrap border-b py-3 text-sm outline-none focus:border-b-2 focus:border-black" id="" rows="6" placeholder="Pertanyaan" name="question"></textarea>
